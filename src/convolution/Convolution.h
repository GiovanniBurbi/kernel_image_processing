...
// Parallel with openMP Unrolling kernel simd width with restrict to pointers
Image_t* convolutionOMPUnrollingSIMDWidthRestrict(Image_t* image, float* kernel, int nThreads);
// Parallel with openMP Unrolling kernel simd width with restrict to pointers and SoA
